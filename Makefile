...
# Variabel
# =========================
WEB_DB_NAME = kangkung2
DOCKER = docker
DOCKER_COMPOSE = ${DOCKER} compose
CONTAINER_ODOO = odoo-17
CONTAINER_DB = odoo17-postgres
USER=odoo
PASSWORD=odoo
include .env
export
...
console:
	$(DOCKER) exec -it $(CONTAINER_ODOO) odoo shell --db_host=$(CONTAINER_DB) -d $(WEB_DB_NAME) -r $(USER) -w $(PASSWORD)
...
# --- Target upgrade addon (make addon estate) ---
addon: restart
